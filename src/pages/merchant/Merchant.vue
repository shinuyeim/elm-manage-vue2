<template>
  <div>
    ...
    >
      ...
      <el-table-column fixed prop="name" label="店铺名称" min-width="100" sortable></el-table-column>
      <el-table-column prop="date" label="注册日期" min-width="100" sortable></el-table-column>
      <el-table-column prop="address" label="店铺地址" min-width="200" sortable></el-table-column>
      <el-table-column label="店铺介绍" min-width="100">
        <template slot-scope="scope">
          <el-popover trigger="hover" placement="top" width="500">
            <p>店铺名称: {{ scope.row.name }}</p>
            <p>店铺介绍: {{ scope.row.introductioni }}</p>
    ...
    <el-dialog title="新增" :visible.sync="dialogFormVisible">
      ...
      <el-form :model="form" :rules="formRules" ref="form">
        ...
        <el-form-item label="店铺介绍" :label-width="formLabelWidth" prop="introductioni">
          <el-input v-model="form.introductioni"></el-input>
        </el-form-item>
